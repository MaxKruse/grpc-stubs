...
type UserClient interface {
	...
	CreateUser(ctx context.Context, in *UserData, opts ...grpc.CallOption) (*UserResponse, error)
	UpdateUser(ctx context.Context, in *UserData, opts ...grpc.CallOption) (*UserResponse, error)
	DeleteUser(ctx context.Context, in *UserData, opts ...grpc.CallOption) (*UserResponse, error)
...
func (c *userClient) CreateUser(ctx context.Context, in *UserData, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
...
func (c *userClient) UpdateUser(ctx context.Context, in *UserData, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
...
func (c *userClient) DeleteUser(ctx context.Context, in *UserData, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
...
func (x *userGetUsersClient) Recv() (*UserResponse, error) {
	m := new(UserResponse)
...
type UserServer interface {
	...
	CreateUser(context.Context, *UserData) (*UserResponse, error)
	UpdateUser(context.Context, *UserData) (*UserResponse, error)
	DeleteUser(context.Context, *UserData) (*UserResponse, error)
...
func (UnimplementedUserServer) CreateUser(context.Context, *UserData) (*UserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateUser not implemented")
}
func (UnimplementedUserServer) UpdateUser(context.Context, *UserData) (*UserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateUser not implemented")
}
func (UnimplementedUserServer) DeleteUser(context.Context, *UserData) (*UserResponse, error) {
...
func _User_UpdateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).UpdateUser(ctx, req.(*UserData))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _User_DeleteUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).DeleteUser(ctx, req.(*UserData))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (x *userGetUsersServer) Send(m *UserResponse) error {
